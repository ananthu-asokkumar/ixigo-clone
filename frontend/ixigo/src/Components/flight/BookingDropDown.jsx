  ...
  const handleChange = (event, newValue) => {
    ...
    return (
        <>
            ...
            {id === isdropDown ? <Box sx={{ width: '100%', typography: 'body1' }} >
            <TabContext value={value}>
                ...
                <TabPanel value="1"><div className={`${styles.allFlights}`} >
                            <div className={`${styles.details}`}>
                                <div className={`${styles.flightCode}`}>
                                    <img height="40px" width="50px" src={myFlight.image} alt="" />
                                    <p>{myFlight.flightName }</p>
                                    <p>{myFlight.flightCode }</p>
                                </div>
                                <div className={`${styles.departureDetails}`}>
                                    <p style={{ marginTop: "30px" }}>{myFlight.departureCode }</p>
                                    <p style={{ fontSize: "20px", paddingBottom: "0px", fontWeight: "500" }}>{myFlight.departureTime }</p>
                                    <p>{ myFlight.departureDate}</p>
                                    <p>{ myFlight.departurePlace}</p>
                                </div>
                                <div className={`${styles.nonStop}`}>
                                    <p style={{ marginLeft: "25px" }}>{`${Math.floor(myFlight.durationInMin /60)}hr  ${myFlight.durationInMin%60}min`} </p>
                                    <hr />
                                    <p style={{ marginLeft: "25px" }}>{myFlight.flightStops }</p>
                                </div>
                                <div className={`${styles.arrivalDetails}`}>
                                    <p style={{ marginTop: "30px" }}>{myFlight.arrivalCode }</p>
                                    <p style={{ fontSize: "20px", paddingBottom: "0px", fontWeight: "500" }}>{myFlight.arrivalTime }</p>
                            ...
                            <div className={`${styles.total}`}>
                                <div style={{ lineHeight: "0cm", marginTop: "20px" }}>
                                    <div style={{ display: "flex", lineHeight: "0cm", marginBottom: "0px", paddingBottom: "0px", marginLeft: "20px" }}>
                                        ...
                                        <p style={{ marginTop: "26px", color: "rgb(236,91,36)", fontWeight: "bold", fontSize: "23px" }}>{ myFlight.basicPrice}</p>
                                    </div>
                                    <div style={{ display: "flex", marginTop: "0px", lineHeight: "0cm", paddingTop: "0px", marginLeft: "20px" }}>
                                        ...
                                        <p style={{ fontSize: "10px", marginTop: "5px", color: "rgb(236,91,36)" }}>{myFlight.offPrice } instant off</p>
                                    </div>
                                </div>
                ...
                <TabPanel value="2">Item Two</TabPanel>
                    <TabPanel value="3">
                        <ul className={`${styles.lists}`}>
                            <li>Airlines may charge an additional fee for baggage, insurance, use of credit cards, etc.</li>
                            <li>Baggage allowance and convenience fee may change based on individual airline policies.</li>
                            <li>Although we try to ensure price accuracy, we can not guarantee absolute pricing due to the dynamic nature of flight fares</li>
                            <li>Please note: We are not a travel agency and do not sell tickets directly. Although you can always get in touch with us at feedback@ixigo.com, for any questions regarding your booking, it is advisable to directly contact the travel agency or airline.</li>
                        </ul>
                    </TabPanel>
                    <TabPanel value="4">
                        <div className={`${styles.booknow}`}>
                            ...
                            <div className={`${styles.assured}`}>
                                ...
                                <div className={`${styles.assuredContent}`} >
                                    <div>
                                        <img src="" alt="" />
                                        <p>Full refund of upto ₹5000 (over and above airline refund) per person per route if you cancel</p>
                                    </div>
                                    <div>
                                        <img src="" alt="" />
                                    ...
                                    <div>
                                        <img src="" alt="" />
                                        <p>
                                            Free Cancellation Premium of ₹459 included</p>
